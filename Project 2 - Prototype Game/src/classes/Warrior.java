...
public class Warrior extends Profession {
	...
	public Warrior(int n) {
		...
		AttributeBonus wstr_bonus = new AttributeBonus(AttributeType.STR, 5, false);
		AttributeBonus wdex_bonus = new AttributeBonus(AttributeType.DEX, 1.5,false);
		AttributeBonus wrange_bonus = new AttributeBonus(AttributeType.RANGE, 1 ,false);
		AttributeBonus wdrange_bonus = new AttributeBonus(AttributeType.D_RANGE, 10, false);
		AttributeBonus whp_bonus = new AttributeBonus(AttributeType.M_HP, 0.1, true);
		AttributeBonus wmp_bonus = new AttributeBonus(AttributeType.M_MP, 0.03, true);
